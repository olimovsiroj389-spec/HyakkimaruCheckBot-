...
# 1. CONFIG
# =========================================================
BOT_TOKEN = "8518958687:AAEhRMIlx5hqR9vbx9MlxuLTUpdUl150Hv4"
...
async def start(update, context):
    ...
    keyboard = [
        ...
        [
            InlineKeyboardButton("📜 Qoidalar", callback_data="start_rules"),
            InlineKeyboardButton("👤 Profilim", callback_data="start_profile"),
        ],
    ]
