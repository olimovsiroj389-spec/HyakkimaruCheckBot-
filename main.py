...
from telegram.constants import ChatMemberStatus, ChatPermissions
...
# 1. CONFIG
# =========================================================
BOT_TOKEN = "8518958687:AAHsBZ-Fdh5O1-tCkhz0AKolGpfdeBbq2Og"
DATABASE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "hyakkimaru.db")

if not BOT_TOKEN or BOT_TOKEN == "8518958687:AAHsBZ-Fdh5O1-tCkhz0AKolGpfdeBbq2Og":
    raise RuntimeError(
        "BOT_TOKENni HyakkimaruBot_single.py ichida BOT_TOKEN = \"...\" qatoriga yozing."
    )
